...
/* public void  insert(Participant p){
  ...
  public LiveData<Long> insertP(Participant t){
    ...
    public LiveData<Participant> getParticipantByName(String fn, String ln){
...
////////////////////////gia Team
   ...
   // public List<TeammatesTuple> getTeammatesid(int teamid){
    ...
    LiveData<List<TeamandRoundScore>> geAllActiveTeamsofChamp( String champid){
        return teamDao.geAllActiveTeamsofChamp(champid);
    }
...
///////////gia Round_detail
    ...
    public LiveData<List<Round_detail>> getAllDoneRound_detailofplayerofChamp(String pid, String chid){
        return rdDao.getAllDoneRound_detailofplayerofChamp(pid,chid);
    }
    ...
    LiveData<List<PlayerandGames>> getAllPlayerScoreGamesofChampofDoneRoundsOrderedByplayer(String chid){
        return rdDao.getAllPlayerScoreGamesofChampofDoneRoundsOrderedByplayer(chid);
    }
